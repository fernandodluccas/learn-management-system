                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            <div className="grid gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    <Button variant="outline" type="button" className="justify-center gap-3 cursor-pointer" disabled>
                                ...
                                <p className="text-center text-sm text-muted-foreground">
                                    Já tem uma conta?{" "}
                                    <Link href="/signin" className="underline cursor-pointer hover:text-foreground">
                                        Entrar
                                    </Link>
                                </p>
                            </div>
